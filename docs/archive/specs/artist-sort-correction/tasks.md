...
**モデル:**
- `src/models/artist_sort_models.py`

**リポジトリ:**
- `src/repositories/artist_sort_mapping_repository.py`

**ユーティリティ:**
- `src/utils/artist_sort_generator.py` (拡張)

**CLI:**
- `src/cli/artist_sort_cli.py`

**サービス:**
- `src/services/song_list_service.py` (統合)

**テスト:**
- `tests/unit/test_artist_sort_mapping_repository.py`
- `tests/unit/test_artist_sort_generator.py`
- `tests/unit/test_artist_sort_cli.py`
- `tests/property/test_artist_sort_mapping_repository_properties.py`
- `tests/property/test_artist_sort_generator_properties.py`
- `tests/integration/test_song_list_service_with_mapping.py`

**ドキュメント:**
- `docs/guides/artist-sort-correction-guide.md`
- `README.md` (更新)
